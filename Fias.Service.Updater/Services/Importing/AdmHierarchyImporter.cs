...
public class AdmHierarchyImporter(
    INpgsqlConnectionFactory factory,
    IOptions<FiasOptions> options,
    ILogger<AdmHierarchyImporter> logger)
    : CopyImporterBase(factory, options, logger)
{
    public override FiasEntityKind Kind => FiasEntityKind.AdmHierarchy;
    protected override string TableName => "fias.adm_hierarchy";
