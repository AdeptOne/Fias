...
public class HouseTypeImporter(
    INpgsqlConnectionFactory factory,
    IOptions<FiasOptions> options,
    ILogger<HouseTypeImporter> logger)
    : CopyImporterBase(factory, options, logger)
{
    public override FiasEntityKind Kind => FiasEntityKind.HouseTypes;
    protected override string TableName => "fias.house_types";
    protected override string RecordElementName => "HOUSETYPE";
