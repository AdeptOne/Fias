...
public class ApartmentTypeImporter(
    INpgsqlConnectionFactory factory,
    IOptions<FiasOptions> options,
    ILogger<ApartmentTypeImporter> logger)
    : CopyImporterBase(factory, options, logger)
{
    public override FiasEntityKind Kind => FiasEntityKind.ApartmentTypes;
    protected override string TableName => "fias.apartment_types";
    protected override string RecordElementName => "APARTMENTTYPE";
